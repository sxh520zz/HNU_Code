...
with open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Wav2vec_XLS-R/Train_data_base.pickle', 'rb') as file:
...
file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Wav2vec_XLS-R/Final_result.pickle', 'wb')
pickle.dump(Final_result,file)
file.close()
file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Wav2vec_XLS-R/Final_f1.pickle', 'wb')
