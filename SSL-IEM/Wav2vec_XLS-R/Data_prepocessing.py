...
processor = Wav2Vec2FeatureExtractor.from_pretrained("/mnt/data1/liyongwei/SSL_Models/facebook/wav2vec2-xls-r-1b")
model = Wav2Vec2Model.from_pretrained("/mnt/data1/liyongwei/SSL_Models/facebook/wav2vec2-xls-r-1b")
...
if __name__ == '__main__':
    ...
    file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Wav2vec_XLS-R/Train_data_base.pickle', 'wb')
