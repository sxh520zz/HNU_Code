...
processor = AutoProcessor.from_pretrained("/mnt/data1/yongwei/SSL_model/facebook/hubert-large-ls960-ft")
model = HubertModel.from_pretrained("/mnt/data1/yongwei/SSL_model/facebook/hubert-large-ls960-ft")
...
if __name__ == '__main__':
    ...
    file = open('/mnt/data1/yongwei/sxh_code/IEMOCAP/SSL/Hubert_vec_large/Train_data_Hubert_large.pickle', 'wb')
