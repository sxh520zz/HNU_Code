...
with open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/SEW/Train_data_base.pickle', 'rb') as file:
...
parser.add_argument('--utt_insize', type=int, default=512)
...
file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/SEW/Final_result.pickle', 'wb')
pickle.dump(Final_result,file)
file.close()
file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/SEW/Final_f1.pickle', 'wb')
