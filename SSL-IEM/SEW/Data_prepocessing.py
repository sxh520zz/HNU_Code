...
processor = AutoProcessor.from_pretrained("/mnt/data1/liyongwei/SSL_Models/asapp/sew-tiny-100k-ft-ls100h")
model = SEWModel.from_pretrained("/mnt/data1/liyongwei/SSL_Models/asapp/sew-tiny-100k-ft-ls100h")
...
if __name__ == '__main__':
    ...
    file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/SEW/Train_data_base.pickle', 'wb')
