...
with open('/mnt/data1/liyongwei/Project/Yongwei_Code/IEM/SSL-IEM/SEW/Final_result.pickle', 'rb') as file:
    final_result =pickle.load(file)
with open('/mnt/data1/liyongwei/Project/Yongwei_Code/IEM/SSL-IEM/SEW/Final_f1.pickle', 'rb') as file:
