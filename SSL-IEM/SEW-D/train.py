...
with open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/SEW-D/Train_data_base.pickle', 'rb') as file:
...
parser.add_argument('--utt_insize', type=int, default=384)
...
file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/SEW-D/Final_result.pickle', 'wb')
pickle.dump(Final_result,file)
file.close()
file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/SEW-D/Final_f1.pickle', 'wb')
