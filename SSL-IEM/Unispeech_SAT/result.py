...
with open('/mnt/data1/liyongwei/Project/Yongwei_Code/IEM/SSL-IEM/Unispeech_SAT/Final_result.pickle', 'rb') as file:
    final_result =pickle.load(file)
with open('/mnt/data1/liyongwei/Project/Yongwei_Code/IEM/SSL-IEM/Unispeech_SAT/Final_f1.pickle', 'rb') as file:
