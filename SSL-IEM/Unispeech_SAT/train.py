...
with open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Unispeech_SAT/Train_data_large.pickle', 'rb') as file:
...
file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Unispeech_SAT/Final_result.pickle', 'wb')
pickle.dump(Final_result,file)
file.close()
file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Unispeech_SAT/Final_f1.pickle', 'wb')
