...
processor = AutoProcessor.from_pretrained("/mnt/data1/liyongwei/SSL_Models/microsoft/unispeech-sat-base-100h-libri-ft")
model = UniSpeechSatModel.from_pretrained("/mnt/data1/liyongwei/SSL_Models/microsoft/unispeech-sat-base-100h-libri-ft")   # 用于提取通用特征，768维
...
if __name__ == '__main__':
    ...
    file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Unispeech_SAT/Train_data_base.pickle', 'wb')
