...
processor = AutoFeatureExtractor.from_pretrained("/mnt/data1/liyongwei/SSL_Models/facebook/data2vec-audio-large-960h")
model = Data2VecAudioForAudioFrameClassification.from_pretrained("/mnt/data1/liyongwei/SSL_Models/facebook/data2vec-audio-large-960h")
...
if __name__ == '__main__':
    ...
    file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Data2vec_large/Train_data_large.pickle', 'wb')
