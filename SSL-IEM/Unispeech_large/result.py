...
with open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Unispeech_large/Final_result.pickle', 'rb') as file:
    final_result =pickle.load(file)
with open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Unispeech_large/Final_f1.pickle', 'rb') as file:
