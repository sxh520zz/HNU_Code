...
processor = AutoProcessor.from_pretrained("/mnt/data1/liyongwei/SSL_Models/microsoft/unispeech-sat-base")
model = UniSpeechModel.from_pretrained("/mnt/data1/liyongwei/SSL_Models/microsoft/unispeech-sat-base")
...
if __name__ == '__main__':
    ...
    file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Hubert_base/Train_data_Hubert_base.pickle', 'wb')
