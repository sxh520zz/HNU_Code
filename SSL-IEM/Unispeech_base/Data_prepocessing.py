...
model = UniSpeechModel.from_pretrained("/mnt/data1/liyongwei/SSL_Models/patrickvonplaten/unispeech-sat-base-timit-ft")   # 用于提取通用特征，768维
...
if __name__ == '__main__':
    ...
    file = open('/mnt/data1/liyongwei/Project/Yongwei_Code/SSL-IEM/Unispeech_base/Train_data_base.pickle', 'wb')
